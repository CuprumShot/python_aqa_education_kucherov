...
# def coffee_number():
# -------------------- не был уверен, нужно ли инпуты вытащить вне класса
#     return input('What do you want to buy? 1 - espresso, 2 - latte, '
...
class CoffeeTime:
    ...
    def fill_menu(self):
        ...
        fill_value = lambda filling: int(input(filling))  # пеп8 не хочет тут лямбду, надо переделать в деф?
